<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-button v-if="hasButton('RR_ROLE_ADD')" class="filter-item" style="margin-left: 10px;" type="primary" icon="el-icon-plus" @click="handleCreate">添加</el-button>
    </div>
    <el-table
      ...
      <el-table-column align="center" label="操作" width="240">
        <template slot-scope="scope">
          <el-button v-if="hasButton('RR_ROLE_EDIT')" type="primary" size="mini" @click="handleUpdate(scope.row)">修改</el-button>
          <el-button v-if="hasButton('RR_ROLE_DEL')" type="danger" size="mini" @click="deleteData(scope.row)">删除</el-button>
          <el-button v-if="hasButton('RR_ROLE_EDIT')" type="info" size="mini" @click="handlerPermission(scope.row)">模块配置</el-button>
        </template>
      </el-table-column>
    </el-table>
